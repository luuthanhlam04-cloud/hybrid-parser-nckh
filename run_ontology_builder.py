...
def main():
    ...
    print(f"    QUARANTINED  : {report.quarantined_mentions}")
    ...
    print(f"    QUARANTINED  : {report.quarantined_edges}")
    print(f"    REJECTED     : {report.rejected_edges}")
    print(f"  References     : {report.classified_references}/{report.total_references} classified")
    print(f"    AMBIGUOUS    : {report.ambiguous_references}")
